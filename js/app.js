...
const inventors = [
  ...
  // 1. Filter the array of inventors into a new array containing only the inventors born in the 1500
  const yearBorn = inventors.filter(bigBrain => bigBrain.year >= 1500 && bigBrain.year <= 1599);
  ...
  const invent = inventors.map(function(names){
  ...
  console.log(comments.find(name))
...
console.log(comments.findIndex(inx));
